...
class TransformerModel(nn.Module):
    ...
    def forward(self, src, src_mask):
        ...
        #hook_handle = self.transformer_encoder.layers[-1].self_attn.register_forward_hook(save_output)


        x = self.transformer_encoder(src, src_mask)
        #att = self.transformer_encoder.layers[0].self_attn
        #att = save_output.outputs[0][0]
