...
def parameter_parser():
    ...
    parser.add_argument('--data-adj-mtx',
                        type=str,
                        default='Training_data/GETNext/4sq/graph_A.csv',
                        help='Graph adjacent path')
    parser.add_argument('--data-node-feats',
                        type=str,
                        default='Training_data/GETNext/4sq/graph_X.csv',
                        help='Graph node features path')
    parser.add_argument('--data-train',
                        type=str,
                        default='Training_data/GETNext/4sq/getnext_nyc_train.csv',
                        help='Training data path')
    parser.add_argument('--data-val',
                        type=str,
                        default='Training_data/GETNext/4sq/getnext_nyc_val.csv',
