...
def parameter_parser():
    ...
    parser.add_argument('--data-adj-mtx',
                        type=str,
                        default='dataset/NYC/previous/Gowalla/graph_A.csv',
                        help='Graph adjacent path')
    parser.add_argument('--data-node-feats',
                        type=str,
                        default='dataset/NYC/previous/Gowalla/graph_X.csv',
                        help='Graph node features path')
    parser.add_argument('--data-train',
                        type=str,
                        default='dataset/NYC/previous/Gowalla/getnext_nyc_train.csv',
                        help='Training data path')
    parser.add_argument('--data-val',
                        type=str,
                        default='dataset/NYC/previous/Gowalla/getnext_nyc_val.csv',
