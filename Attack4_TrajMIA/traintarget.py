...
def train(args,train2_path,train3_path):
    ...
    lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
        optimizer, 'min', min_lr=0.001, verbose=True, factor=args.lr_scheduler_factor)
    ...
    for epoch in range(args.epochs):
        ...
        save_p= "./dataset_4sq/lira/prediction/target"+str(epoch)+".npz"
        print(save_p)
        all_pred = []
...
if __name__ == '__main__':
    ...
    args.epochs = 200#100
    args.project='runs_4sq/target_all'
